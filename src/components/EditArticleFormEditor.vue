    ...
    <div class="modal-content">
      <b-col md="11" class="mx-auto">
        <b-form class="justify-content-center" @submit.prevent="onSubmit">
          ...
          <b-form-group label="Content" :state="!!content" invalid-feedback="Content is required" class="mb-2">
          ...
          <b-button class="mb-2" @click="onPublishSubmit" variant="primary">Publish</b-button>
...
export default {
  ...
  methods: {
    ...
    onPublishSubmit() { //PUBLISH, create another onSubmit for Edit, copy paste the edit from EditArticleForm
      // Handle the form submission logic here
      console.log("Form submitted:", this.form);
      ...
      const articleData = {
        ...
        Editor: this.$store.state.user.firstname + " " + this.$store.state.user.lastname,
        company: this.form.company,
        status: "Published",
      };
